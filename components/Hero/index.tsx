    ...
    return(
        ...
        <div className="w-full overflow-hidden py-20 sm:py-32 lg:pb-32 xl:pb-36 relative md:px-6 lg:px-8" style={{ "backgroundImage": `url(${'https://d1gr3r269tafbs.cloudfront.net/extras/spc-builder/hero-background_1683534928.png'})`, "backgroundSize": "cover", "height": "600px", "backgroundPosition": "center center",  "backgroundAttachment": "scroll" }}>
            ...
            <div className="sm:mb-4 sm:flex sm:justify-start">
                <h5 className="relative rounded-full py-1 px-3 text-sm leading-6 text-white">
                    420 jobs in 69 locations
                </h5>
            </div>
            <div className="text-left">
                <h1 className="font-extrabold tracking-tight text-white text-6xl">Join the grocery revolution</h1>
                <div className="mt-10 flex items-center justify-start gap-x-6">
                    <Link href={"/jobs"} className="rounded bg-greenish px-5 py-2.5 text-base font-semibold leading-7 text-white shadow-sm hover:bg-red-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-red-600 shake">All Jobs</Link>
                </div>
            </div>
        </div>
