...
const TextMedia = () => {
    ...
    return(
        ...
        <div className="w-full bg-white pt-4">
            ...
            <div className="mx-auto max-w-7xl lg:mx-0 lg:grid lg:max-w-7xl lg:grid-cols-2 lg:gap-x-16 lg:gap-y-6 xl:grid-cols-1 xl:grid-rows-1 xl:gap-x-4 align-center">
                <h2 className="max-w-2xl text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl lg:col-span-2 xl:col-auto pb-4">Join the team!</h2>
            ...
            <Image src="https://images.unsplash.com/photo-1567532900872-f4e906cbf06a?ixlib=rb-4.0.3&amp;ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&amp;auto=format&amp;fit=crop&amp;w=420&amp;q=80" width={420} height={350} alt="" className="mt-8 lg:mt-0 w-full rounded object-cover lg:max-w-none xl:row-span-2 xl:row-end-2" /></div></div>
